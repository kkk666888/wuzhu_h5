  ...
  <div class="shopTest">
    ...
    <div class="section2">
      <tab :line-width=3 custom-bar-width="60px" active-color='#FFDA29' v-model="declarePlaneIndex">
        <tab-item class="vux-center" :selected="declarePlaneDefault === item" v-for="(item, declareIndex) in declareList"
                  @click="declarePlaneDefault = item" :key="declareIndex">{{item}}
        </tab-item>
      </tab>
      <div class="wrapDiv">
