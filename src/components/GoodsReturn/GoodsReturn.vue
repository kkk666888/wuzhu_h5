<template>
  <div class="GoodsReturn">
    <div class="return-content">
      <div class="return-info">
        ...
        <div class="choose-logistics" @click="chooseLogistics">
          ...
          <span v-else class="logistics-button other-logistics" data-companycode="10" id="other">
        ...
        <div class="logistics-number ">
          <!--添加group会出现线条-->
          <x-input :max="40" title="物流单号" class="vux-1px-b" v-model="deliveryOrderNo" :is-type="logisticsNo"
                   placeholder="请输入物流编号" @on-blur="setWindowSize"></x-input>
        </div>
    ...
    <div class="btnPlane">
      <x-button type="primary" :disabled="returnBtnDisabled" :show-loading="returnBtnDisabled" class="submitReturn-btn"
                action-type="button" @click.native="applyReturnNote">确认归还
      </x-button>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        expressCompanyCode: '', // 物流公司编号 1、京东，2、顺丰，10、其他
    ...
    created() {
      ...
      // for test
      // this.goodsReturnOrderNo({ goodsReturnOrderNo: '00120181203M044284279393' });
    },
    mounted() {
      this.getAddressInfo();
    },
