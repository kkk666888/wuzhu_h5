...
export function GetWXLocation(instance) {
  console.log('GetWXLocation start')
  let that = instance;
  return new Promise(function(resolve, reject) {
    try {
      console.log('GetWXLocation Promise')
      if (!isWeiXin()) {
        reject(new Error('isNotWeixin'));
        console.log('GetWXLocation is not weixin')
        return false;
      }
      console.log('GetWXLocation isWeiXin')
      // eslint-disable-next-line
      wx.getLocation({
        type: 'wgs84', // gcj02
        ...
        fail: function(res) {
          ...
          // console.log('getlocationFailed', res);
        },
        cancel: function() {
...
export function GetBaiduGps() {
  console.log('GetBaiduGps start')
  return new Promise((resolve, reject) => {
    // 百度地图API功能
    // eslint-disable-next-line
    let geolocation = new BMap.Geolocation();
    console.log('GetBaiduGps geolocation')
